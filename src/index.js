...
import { DialogIdEditor, StartMethodEditor } from "./dialog-id-editor";
...
Object.assign(JSONEditor.defaults.editors, {...editors, DialogIdEditor, StartMethodEditor})
JSONEditor.defaults.resolvers.unshift(schema => schema.type==='string' && schema.format==='dialogid' && 'DialogIdEditor');
// JSONEditor.defaults.resolvers.unshift(schema => schema.type==='string' && schema.format==='dialogStartMethod' && 'StartMethodEditor');
